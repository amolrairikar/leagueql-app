...
_ENV = {
    ...
    # BE-022: the webhook fans out an async invoke of the recap lambda. The invoke
    # is bridged to call the recap handler directly (no real Lambda runtime).
...
def _load_handlers(context) -> None:
    ...
    class _RecapInvokeBridge:
        def invoke(self, FunctionName, InvocationType, Payload):
            ...
            context.recap_handler.lambda_handler(event, None)
