...
const feature = loadFeature(
  'src/features/analytics/__tests__/analytics.feature',
);
...
defineFeature(feature, (test) => {
  test('The chart renders for a season with regular-season games', ({
    given,
    when,
    then,
    and,
  ...
  test('A season without regular-season data shows an empty state', ({
    given,
    when,
    then,
  }) => {
