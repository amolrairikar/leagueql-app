Feature: Weekly recap (FE-033)
  The matchups page hosts a premium weekly recap section below the weekly awards:
  ...
  Scenario: An expired subscription shows the locked overlay without fetching data
    ...
    When I open the gated recap
    Then I see the paywall heading "Weekly recap is a premium feature"
